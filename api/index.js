...
const clientId = process.env.CLIENT_ID;
const clientSecret = process.env.CLIENT_SECRET;
const redirectUri = "https://spotify-liked-playlist-iota.vercel.app/api/callback";  // Adjusted for Vercel
...
app.get("/", (req, res) => {
  res.sendFile(path.join(__dirname, "../index.html"));  // Adjust path to serve the HTML file
});
